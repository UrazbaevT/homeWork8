...
public class RPG_Game {
    ...
    public static void start() {
        ...
        Thor thor = new Thor(230, 15, "Baiel");
        Golem golem = new Golem(1000, 5, "Dosya");
        Witcher witcher = new Witcher(500, 0, "Witcher");
        IronMan ironMan = new IronMan(200, 5, "Tony Stark");
        Hero[] heroes = {warrior, doc, magic, berserk, junior, thor, golem, witcher, ironMan};
